...
public struct MessageObject: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String, object: Object, createdAt: Int, threadId: String, status: Status, incompleteDetails: MessageObjectIncompleteDetails?, completedAt: Int?, incompleteAt: Int?, role: Role, content: [MessageObjectContentInner], assistantId: String?, runId: String?, attachments: [MessageObjectAttachmentsInner]?, metadata: [String: RawJSON]?) {
        self.id = id
        self.object = object
