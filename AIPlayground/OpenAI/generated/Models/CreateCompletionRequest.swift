...
public struct CreateCompletionRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(model: CreateCompletionRequestModel, prompt: CreateCompletionRequestPrompt?, bestOf: Int? = 1, echo: Bool? = false, frequencyPenalty: Double? = 0, logitBias: [String: Int]? = nil, logprobs: Int? = nil, maxTokens: Int? = 16, n: Int? = 1, presencePenalty: Double? = 0, seed: Int? = nil, stop: CreateCompletionRequestStop? = nil, stream: Bool? = false, streamOptions: ChatCompletionStreamOptions? = nil, suffix: String? = nil, temperature: Double? = 1, topP: Double? = 1, user: String? = nil) {
        self.model = model
        self.prompt = prompt
        self.bestOf = bestOf
        self.echo = echo
