...
public struct ChatCompletionRequestAssistantMessage: Codable, JSONEncodable, Hashable {
    ...
    public init(content: ChatCompletionRequestAssistantMessageContent? = nil, refusal: String? = nil, role: Role, name: String? = nil, toolCalls: [ChatCompletionMessageToolCall]? = nil, functionCall: ChatCompletionRequestAssistantMessageFunctionCall? = nil) {
