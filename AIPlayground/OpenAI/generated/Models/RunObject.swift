...
public struct RunObject: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String, object: Object, createdAt: Int, threadId: String, assistantId: String, status: Status, requiredAction: RunObjectRequiredAction?, lastError: RunObjectLastError?, expiresAt: Int?, startedAt: Int?, cancelledAt: Int?, failedAt: Int?, completedAt: Int?, incompleteDetails: RunObjectIncompleteDetails?, model: String, instructions: String, tools: [AssistantObjectToolsInner], metadata: [String: RawJSON]?, usage: RunCompletionUsage?, temperature: Double? = nil, topP: Double? = nil, maxPromptTokens: Int?, maxCompletionTokens: Int?, truncationStrategy: TruncationObject, toolChoice: AssistantsApiToolChoiceOption, parallelToolCalls: Bool = true, responseFormat: AssistantsApiResponseFormatOption) {
        self.id = id
        self.object = object
