...
public struct AssistantObject: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String, object: Object, createdAt: Int, name: String?, description: String?, model: String, instructions: String?, tools: [AssistantObjectToolsInner], toolResources: AssistantObjectToolResources? = nil, metadata: [String: RawJSON]?, temperature: Double? = 1, topP: Double? = 1, responseFormat: AssistantsApiResponseFormatOption? = nil) {
        self.id = id
        self.object = object
