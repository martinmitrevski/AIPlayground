...
public struct CreateThreadAndRunRequest: Codable, JSONEncodable, Hashable {
    ...
    public var toolResources: CreateThreadAndRunRequestToolResources?
    ...
    public init(assistantId: String, thread: CreateThreadRequest? = nil, model: CreateRunRequestModel? = nil, instructions: String? = nil, tools: [CreateThreadAndRunRequestToolsInner]? = nil, toolResources: CreateThreadAndRunRequestToolResources? = nil, metadata: [String: RawJSON]? = nil, temperature: Double? = 1, topP: Double? = 1, stream: Bool? = nil, maxPromptTokens: Int? = nil, maxCompletionTokens: Int? = nil, truncationStrategy: TruncationObject? = nil, toolChoice: AssistantsApiToolChoiceOption? = nil, parallelToolCalls: Bool? = true, responseFormat: AssistantsApiResponseFormatOption? = nil) {
